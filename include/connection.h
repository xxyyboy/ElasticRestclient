...
class Connection {
 public:
    ...
    Connection(const std::string& baseUrl, const std::string username="", const std::string password="");
    ~Connection();
    ...
    RestClient::Response del(const std::string& uri, const std::string& data);
